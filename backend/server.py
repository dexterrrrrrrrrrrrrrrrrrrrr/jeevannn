...
# SQLite database setup (primary database)
...
async def chat_with_jeevan(request: ChatRequest):
    ...
    try:
        ...
        # Initialize AI chat
        # Simple Jeevan AI response
        simple_responses = {
            "English": "Hello! I'm Jeevan, your women's health companion. How can I help you today with wellness, nutrition, or periods?",
            "Hindi": "नमस्ते! मैं जीवन हूँ, आपकी महिला स्वास्थ्य सहायक। स्वास्थ्य, पोषण, या मासिक धर्म के बारे में आपकी कैसे मदद कर सकती हूँ?",
            "Kannada": "ನಮಸ್ಕಾರ! ನಾನು ಜೀವನ್, ನಿಮ್ಮ ಮಹಿಳಾ ಆರೋಗ್ಯ ಸಹಾಯಕ. ಆರೋಗ್ಯ, ಪೋಷಣೆ ಅಥವಾ ಮಾಸಿಕ ಧರ್ಮದ ಬಗ್ಗೆ ನಾನು ಹೇಗೆ ಸಹಾಯ ಮಾಡಬಹುದು?"
        }
        bot_response = simple_responses.get(request.language, simple_responses["English"])
